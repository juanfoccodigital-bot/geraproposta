...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "Geracao com IA", included: false },
    ],
    cta: "Comecar Gratis",
    ctaLink: "/signup",
  },
  {
    ...
    features: [
      ...
      { text: "2 GeraSites", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Geracao com IA", included: true },
      { text: "CRM integrado", included: true },
      { text: "Logo e slug personalizados", included: true },
      { text: "10 GeraLinks", included: true },
      { text: "10 GeraSites", included: true },
    ],
    cta: "Assinar Pro",
    ctaLink: "/signup",
  },
  {
    ...
    features: [
      ...
      { text: "GeraSites ilimitados", included: true },
    ],
    cta: "Assinar Plus",
    ctaLink: "/signup",
  },
...
const comparisonRows = [
  ...
  { label: "Geracao com IA", free: false, lite: false, pro: true, plus: true, category: "Features" },
  ...
  { label: "GeraSites", free: "—", lite: "2", pro: "10", plus: "Ilimitado", category: "Extras" },
];
