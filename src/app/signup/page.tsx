...
/* ============================================
   SIGNUP PAGE
   Registro com email + senha + Google OAuth
   ============================================ */
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6" style={{ background: "#0A0A0A" }}>
        <div className="w-full max-w-sm text-center">
          ...
          <Link
            href="/login"
            className="inline-block px-6 py-3 rounded-xl text-white text-sm font-medium transition-all hover:opacity-90"
    ...
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: "#0A0A0A" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs" style={{ color: "#737373" }}>ou cadastre com email</span>
          <div className="flex-1 h-px" style={{ background: "#262626" }} />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {/* Strength indicator */}
            {password && (
              <div className="mt-2 h-1 rounded-full overflow-hidden" style={{ background: "#262626" }}>
                <div
        ...
        {/* Termos */}
        <p className="text-center mt-4 text-xs" style={{ color: "#737373" }}>
        ...
        <p className="text-center mt-6 text-sm" style={{ color: "#737373" }}>
          Já tem conta?{" "}
          <Link href="/login" className="font-medium hover:underline" style={{ color: "#F97316" }}>
            Entrar
          </Link>
        </p>
      </div>
